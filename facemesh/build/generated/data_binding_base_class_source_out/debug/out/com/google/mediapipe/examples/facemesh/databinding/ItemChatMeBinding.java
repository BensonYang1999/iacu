...
public final class ItemChatMeBinding implements ViewBinding {
  ...
  @NonNull
  public static ItemChatMeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemChatMeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_chat_me, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemChatMeBinding bind(@NonNull View rootView) {
