...
public final class ActivityCameraBinding implements ViewBinding {
  ...
  private ActivityCameraBinding(@NonNull LinearLayout rootView, @NonNull FrameLayout frameCamera) {
  ...
  public static ActivityCameraBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FrameLayout frameCamera = ViewBindings.findChildViewById(rootView, id);
      if (frameCamera == null) {
        break missingId;
      }

      return new ActivityCameraBinding((LinearLayout) rootView, frameCamera);
    }
