...
public final class ActivityMenuBinding implements ViewBinding {
  ...
  private ActivityMenuBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnDiag,
      @NonNull Button btnLearning, @NonNull TextView textView) {
  ...
  public static ActivityMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.btn_diag;
      Button btnDiag = ViewBindings.findChildViewById(rootView, id);
      if (btnDiag == null) {
        break missingId;
      }

      id = R.id.btn_learning;
      ...
      return new ActivityMenuBinding((ConstraintLayout) rootView, btnDiag, btnLearning, textView);
    }
