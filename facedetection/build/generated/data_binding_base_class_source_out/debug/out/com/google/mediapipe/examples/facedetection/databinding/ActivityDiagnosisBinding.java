...
public final class ActivityDiagnosisBinding implements ViewBinding {
  ...
  private ActivityDiagnosisBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button buttonGchatSend, @NonNull EditText editGchatMessage,
      @NonNull RelativeLayout layoutGchatChatbox, @NonNull AppBarLayout layoutGroupChat,
      @NonNull RecyclerView recyclerGchat, @NonNull TextView textGchatIndicator,
      @NonNull View view) {
  ...
  public static ActivityDiagnosisBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDiagnosisBinding((ConstraintLayout) rootView, buttonGchatSend,
          editGchatMessage, layoutGchatChatbox, layoutGroupChat, recyclerGchat, textGchatIndicator,
          view);
    }
